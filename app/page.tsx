...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* ── HERO ── */}
      <section style={{background:'#0D3318', minHeight:'100vh', position:'relative', overflow:'hidden', paddingTop:99, display:'flex', alignItems:'center'}}>
        ...
        <div className="relative max-w-7xl mx-auto px-4 lg:px-8 w-full" style={{paddingTop:'2rem', paddingBottom:'3rem'}}>
